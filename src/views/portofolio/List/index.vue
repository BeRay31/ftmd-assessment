            ...
            <tr v-for="course in courses" :key="course.id_course">
              ...
              <td class="action">
                <el-button
                  ...
                  @click="goToPortfolioDetails(course)"
                >Lihat Portfolio</el-button>
              </td>
            </tr>
          </template>
        </table>
...
export default {
  ...
  methods: {
    ...
    goToPortfolioDetails(course) {
      this.$router.push({ name: 'PortfolioDetails', params: { id: course.id_course }})
    }
  }
}
</script>
